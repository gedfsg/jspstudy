...
<%
    ...
    if (result > 0) {
        response.sendRedirect(request.getContextPath() + "/channel/list.jsp?channelId=" + channelId);
    } else {
        response.sendRedirect(request.getContextPath() + "/channel/write.jsp?channelId=" + channelId);
    }
%>
